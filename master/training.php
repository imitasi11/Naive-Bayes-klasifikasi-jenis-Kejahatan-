...
$value[$no_data[$i]]["hasil"]=$data[$no_data[$i]][2];
}
...
for($i=1;$i<=count($data);$i++){
    if($data[$no_data[$i]][2]>$third){
        $data[$no_data[$i]][2]=4;
    }elseif ($data[$no_data[$i]][2]>$second) {
        $data[$no_data[$i]][2]=3;
    }elseif ($data[$no_data[$i]][2]>=$first){
        $data[$no_data[$i]][2]=2;
    }else{
        $data[$no_data[$i]][2]=1;
    }
...
for($i=1;$i<=count($data);$i++){
    if($data[$no_data[$i]][3]>$thirds){
        $data[$no_data[$i]][3]=4;
    }elseif ($data[$no_data[$i]][3]>$seconds) {
        $data[$no_data[$i]][3]=3;
    }elseif ($data[$no_data[$i]][3]>=$firsts){
        $data[$no_data[$i]][3]=2;
    }else{
        $data[$no_data[$i]][3]=1;
    }
...
<body>
    ...
    <section class="breadcrumb breadcrumb_bg" style="min-height: 670px;">
        <div class="container" align="right" style="margin-top: 130px;">
            <a class="btn btn-primary" href="training/input.php">Tambah Data</a>
        </div>
                ...
                <thead>
                  <tr>
                   ...
                   <tbody>
                        ...
                        ?>  <td><a class="btn btn-primary" href="training/edit.php?id=<?php echo $id_datas; ?>">edit</a></td>
                            <td><a class="btn btn-danger" href="training/hapus.php?id=<?php echo $id_datas; ?>">delete</a></td></tr> <?php
