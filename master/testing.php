...
for($i=1;$i<=count($data);$i++){
    if($data[$i][3]>$third){
        $data[$i][3]=4;
    }elseif ($data[$i][3]>$second) {
        $data[$i][3]=3;
    }elseif ($data[$i][3]>=$first){
        $data[$i][3]=2;
    }else{
        $data[$i][3]=1;
    }
...
<body>
  ...
  <form class="form-contact comment_form" action="testing/aksi.php" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group" align="justify">
                            Nama Tersangka
                              <input class="form-control" name="name" id="name" type="text" placeholder="Nama Tersangka">
                           </div>
                        </div>
              ...
              ?>
                       <div class="col-sm-6">
                           <div class="form-group" align="justify">
                            ...
                            ?>
              <?php echo '<input type="number"  class="form-control" name="'.$ini.'">' ?>
              <?php 
              }else{?>
      ...
      ?>
                      <div class="col-sm-6" style="margin-top: 19px;">
                           <div class="form-group" align="justify">
                     <input class="form-control" name="tanggal" type="date" value="<?php echo date('Y-m-d'); ?>" />
                 </div></div>
                     </div>
