...
<body>
  ...
  <form class="form-contact comment_form" action="aksi.php" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group" align="justify">
                            Nama Kasus
                              <input class="form-control" name="name" id="name" type="text" placeholder="Nama Kasus">
                           </div>
                        </div>
      ...
      ?>
                    <div class="col-sm-6" style="margin-bottom:19px;">
                           <div class="form-group" align="justify" >
                             <?php echo $kriteria[$nokriteria[1]];
                            ?>
              
                <?php echo '<select class="form-control input-sm m-bot15" name="'.$nokriteria[1].'">' ?>
                
              <?php
              for($w=1;$w<=count($parameter[$nokriteria[1]]);$w++){?>
                <option value="<?php echo $w;?>"><?php echo $parameter[$nokriteria[1]][$w]?></option>
            <?php }?>
                </select>
                </div></div>
                     </div>
